...
export const photoProjects: PhotoProject[] = [
  ...
  },
  {
    ...
    images: [
      { aspect: "aspect-[3/2]", src: landfillCoverAsset.url },
      { aspect: "aspect-[3/2]", src: lfLineup.url },
      { aspect: "aspect-[3/2]", src: lfDuo.url },
      { aspect: "aspect-[3/2]", src: lfCrew.url },
      { aspect: "aspect-[3/2]", src: lfCrewWide.url },
      { aspect: "aspect-[3/2]", src: lfBacks.url },
      { aspect: "aspect-[3/2]", src: lfWall.url },
      { aspect: "aspect-[2/3]", src: lfRed.url },
      { aspect: "aspect-[2/3]", src: lfStripes.url },
    ],
  },
  {
    slug: "roots",
